...
[ExecuteInEditMode]
public class Reel : TweenableBase<float>
{
    ...
    public override void SetTweenableValue(int index, float value)
    {
        switch (index)
        {
             case 0: slotSpacing = value; break;
             case 1: slotHeight = value; break;
             case 2: scroll = value; break;
             case 3: offset = value; break;
        }
    }
    ...
    public override float GetTweenableValue(int index)
    {
        switch (index)
        {
             case 0: return slotSpacing;
             case 1: return slotHeight;
